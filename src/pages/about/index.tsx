      ...
      <SectionWrapper>
        <div className='mx-4 mt-12 flex max-w-7xl flex-1 flex-col'>
          ...
          <p className='mt-2'>
            ...
            осушення повітря для державних установ і великих компаній в Україні
            та Європі.
          </p>
          <p className='mt-2'>
          ...
          <p className='mt-2'>
            ...
            завдяки високоякісним продуктам та послугам у сфері HVAC. Кожна наша
            реалізація – це синонім інноваційності, надійності та задоволення
            потреб наших клієнтів.
          </p>
          <hr className='my-4' />
          <h4>Наше бачення</h4>
          <p className='mt-2'>
            ART-COMFORT прагне стати провідною компанією у сфері HVAC у Європі,
            відомою своїми інноваційними підходами, професіоналізмом і високим
            рівнем обслуговування. Ми хочемо бути першим вибором для клієнтів,
            які шукають комплексні та довговічні рішення у вентиляції,
            кондиціонуванні, осушенні й зволоженні повітря.
          </p>
          <hr className='my-4' />
          ...
          <ol className='ml-4 mt-2 flex list-decimal flex-col gap-2'>
            ...
            <li>
              ...
              <p className='mt-2 text-sm'>
                ...
                виробників, таких як{' '}
                <strong>Daikin, Mitsubishi Electric, Systemair, Carel,</strong>{' '}
          ...
          <h4 className='mt-8 text-xl'>{aboutUsTranslations.licensesTitle}</h4>
          ...
          <ul className='ml-4 list-disc text-sm'>
            <li>
              <strong>Обстеження систем вентиляції та кондиціонування:</strong>
              Точна діагностика для оцінки стану та ефективності систем.
            </li>
            <li>
              <strong>Проєктування HVAC-систем: </strong>Розробка індивідуальних
              проектів із використанням інструментів Revit та AutoCAD.
            </li>
            <li>
            ...
            <li>
              <strong>Ремонт HVAC-систем:</strong> Швидке усунення несправностей
              із використанням оригінальних комплектуючих.
            </li>
          </ul>
          <hr className='my-4' />
          <h4>Наш колектив</h4>
          <p>
            Команда <strong>ART-COMFORT</strong> складається з 24 професіоналів,
            які регулярно підвищують свою кваліфікацію. Наші спеціалісти мають
            досвід у реалізації проектів для офісів, торгових центрів,
            фармацевтичних об’єктів, адміністративних будівель та ресторанного
            бізнесу.
          </p>
          <hr className='my-4' />
          ...
          <ul className='ml-4 list-disc text-sm'>
            <li>
              <strong>ПАО "ФАРМАК"</strong> – створення та обслуговування систем
              вентиляції для фармацевтичного виробництва.
            </li>
            <li>
