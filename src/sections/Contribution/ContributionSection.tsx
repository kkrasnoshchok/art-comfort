export const ContributionSection = () => {
  return (
    <section id='#contribution' className='my-24 flex w-screen flex-col px-6'>
      ...
      <div className='h-10/12 mt-12 flex'>
        <div className='p mr-4 flex flex-1 flex-col'>
          ...
          <p className='rounded-lg border-2 p-4'>
            ...
            наближення перемоги а саме: - пряма фінансова допомога нашій
            державі; - формування та відправка гуманітарної допомоги в район
            Бучі, Ірпеня, Бородянки під час окупації та в перші дні та тижні
            після їх звільнення; - виготовлення тушонки та відправка з іншими
            продуктами харчування в регіони які найбільше того потребували - с.
            Горенка, с. Пісківка, м. Звягель (поселення тимчасово переміщених
            жителів Київщини), м. Бородянка, м. Харків; - ремонт автомобілів для
            ЗСУ та інших служб; - придбання та передача матеріальних цінностей
            на запити від різних підрозділів наших захисників; - своєчасна
            сплата податків до бюджету України.
          </p>
          <p className='my-6 rounded-lg border-2 p-4'>
