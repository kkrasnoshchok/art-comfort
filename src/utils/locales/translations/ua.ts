...
export const ua: TranslationType = {
  ...
  welcome: {
    ...
    subtitle:
      'Абсолютний лідер в сфері кондиціонування, вентиляції та опалення. ',
  ...
  services: {
    ...
    design: {
      title: 'Проектування',
      subtitle:
        'Проектування систем ОВІК, BMS, безпеки, водопостачання та електрики',
      description:
        'Проектування – це не просто креслення, це створення ідеальної основи для вашого об’єкта. Ми знаємо, як втілити найскладніші технічні рішення: від систем рекуперації тепла у фармацевтичних лабораторіях до автоматизації адміністративних будівель. Дізнайтеся, як наші проекти забезпечують комфорт, енергоефективність та бездоганну функціональність.',
      longDescription: designServiceLongDescriptionMarkdown,
    },
    supply: {
      title: 'Постачання',
      subtitle:
        'Постачання обладнання для систем ОВІК, BMS, безпеки та водопостачання',
      description:
        'Уявіть світ, де кожна деталь вашого проекту ідеально поєднується: кондиціонери створюють комфортний мікроклімат, вентиляція дихає свіжістю, а автоматизація управляє всім без вашого втручання. Хочете дізнатися, як ми досягаємо цього за допомогою обладнання найвищої якості? Відвідини заводів, співпраця з провідними брендами та наш досвід роблять це реальністю.',
      longDescription: supplyServiceLongDescriptionMarkdown,
    },
    installation: {
      title: 'Встановлення',
      subtitle: 'Встановлення систем для комерційних об’єктів',
      description:
        'Чи готові ви побачити, як інженерна магія оживає на вашому об’єкті? Ми виконуємо монтажні роботи будь-якої складності – від стандартних систем до найвибагливіших проектів. Сертифікати, ліцензії та дозвіл на виконання небезпечних робіт – це лише частина нашої впевненості. Дізнайтеся, як ми перетворюємо креслення на досконалу реальність.',
      longDescription: installationServiceLongDescriptionMarkdown,
    },
    maintenance: {
      title: 'Технічне обслуговування',
      subtitle: 'Технічне обслуговування інженерних систем',
      description:
        'Ваші інженерні системи заслуговують на найкращий сервіс, виконаний професіоналами. Ми сертифіковані провідними виробниками, такими як Daikin, Mitsubishi Electric, Systemair та іншими, щоб гарантувати, що ваше обладнання працює бездоганно. Дізнайтеся, як ми забезпечуємо надійність ваших систем на роки вперед',
