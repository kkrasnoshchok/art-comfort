...
export const ua: TranslationType = {
  ...
  services: {
    ...
    design: {
      ...
      longDescription:
        'Проектування кліматичних систем, це комплексний, цікавий та творчий процес, який має врахувати та узгодити велику кількість факторів, вимог та побажань кінцевого споживача. Сам процес проектування має чітку послідовність певних етапів: Розробка технічного завдання на проектування; Отримання, аналіз та збір вихідних даних; Розробка та погодження з замовником концептуальних рішень; Проведення розрахунків та підбір обладнання, яке найкраще відповідає вимогам замовника; Розробка графічної частини проекту в 3D або 2D моделях; Складання детальної специфікації обладнання, матеріалів, компонентів систем та елементів кріплення; Складання кошторисної документації в комерційному вигляді або в програмних комплексах АВК-5, Кошторис 8; Узгодження та затвердження проекту замовником; Проходження комплексної державної експертизи та отримання позитивного експертного звіту (за необхідності).',
    },
    supply: {
      title: 'Постачання',
      description:
